      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute z-50 mt-2 border rounded-xl shadow-2xl shadow-black/50 backdrop-blur-xl ${
              align === 'right' ? 'right-0' : 'left-0'
            } ${className}`}
            style={{
              originX: align === 'right' ? 1 : 0,
              originY: 0,
              background: 'linear-gradient(180deg, rgba(17,18,27,0.96), rgba(8,9,14,0.97))',
