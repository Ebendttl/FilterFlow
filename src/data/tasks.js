...
const PROJECTS = ['Core App', 'Render Deploy', 'Analytics Engine', 'Design System', 'API Integration'];
...
export function generateTasks() {
  return [
    ...
    { id:'FF-102', title:'Configure Render static site rewrites & publish directory', status:'done', priority:'high', project:'Render Deploy', assignee:TEAM_MEMBERS[1], dueDate:'2026-05-29', createdAt:'2026-05-18', tags:['render','deployment'] },
    ...
    { id:'FF-111', title:'Research Render routing options for SPA fallbacks', status:'todo', priority:'none', project:'Render Deploy', assignee:{ name:'Unassigned', initials:'--', color:'bg-zinc-800' }, dueDate:'2026-06-20', createdAt:'2026-05-27', tags:['research'] },
